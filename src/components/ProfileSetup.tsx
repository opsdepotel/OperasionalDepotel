...
import { User, Shield, Briefcase, Mail, Save, AlertCircle, Plus, Edit2, ArrowLeft, Search, Lock, Fuel, Smartphone, RotateCcw, CheckCircle2, History, FileSpreadsheet, Clock, Tag, Trash2, Loader2, RefreshCw, BellRing } from 'lucide-react';
                ...
                >
                  ...
                  {(p.divisi || p.managerEmail || p.deviceId || p.aksesBBM || p.mobile) && (
                    <div className="pt-2 border-t border-slate-100/80 flex flex-wrap items-center gap-1.5 text-[10px]">
                      ...
                      {p.pushSubscriptions && p.pushSubscriptions.length > 5 && (
                        <span className="text-[9px] font-bold bg-emerald-50 text-emerald-700 px-1.5 py-0.5 rounded-md border border-emerald-200/60 flex items-center gap-1">
