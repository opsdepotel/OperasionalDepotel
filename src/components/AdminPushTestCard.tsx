...
export const AdminPushTestCard: React.FC<AdminPushTestCardProps> = ({
  ...
  return (
    <div
      ...
      className={`rounded-2xl border border-sky-200 bg-gradient-to-br from-sky-50/70 via-white to-indigo-50/40 shadow-md transition-all overflow-hidden ${className}`}
    >
      {/* Header with toggle */}
      <div
        onClick={() => setIsOpen(!isOpen)}
        className="p-4 sm:p-5 flex items-center justify-between gap-3 cursor-pointer select-none hover:bg-sky-50/50 transition-colors"
      >
        <div className="flex items-center gap-3.5">
          <div className="w-11 h-11 rounded-2xl bg-sky-600 text-white flex items-center justify-center shrink-0 shadow-md shadow-sky-200">
          ...
          <div>
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <span className="text-[10px] font-bold bg-sky-100 text-sky-800 px-2 py-0.5 rounded-full border border-sky-300/60 uppercase">
                Fitur Administrator
              </span>
        ...
        <button
          type="button"
          className="w-8 h-8 rounded-xl bg-slate-100 text-slate-600 hover:bg-slate-200 flex items-center justify-center shrink-0 transition-colors"
      ...
      {/* Expandable Body */}
      {isOpen && (
        <div className="p-4 sm:p-5 pt-0 border-t border-sky-100 space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              <button
                ...
                className="px-2.5 py-1 text-[11px] font-semibold rounded-lg bg-sky-100/70 hover:bg-sky-200 text-sky-800 border border-sky-200 transition-colors"
              >
                🔔 Uji Sambungan
              </button>
              <button
                ...
                className="px-2.5 py-1 text-[11px] font-semibold rounded-lg bg-indigo-100/70 hover:bg-indigo-200 text-indigo-800 border border-indigo-200 transition-colors"
              >
                📋 Laporan Kegiatan
              </button>
              <button
                ...
                className="px-2.5 py-1 text-[11px] font-semibold rounded-lg bg-purple-100/70 hover:bg-purple-200 text-purple-800 border border-purple-200 transition-colors"
              >
                ⚡ Pembaruan UID
              </button>
              <button
                ...
                className="px-2.5 py-1 text-[11px] font-semibold rounded-lg bg-rose-100/70 hover:bg-rose-200 text-rose-800 border border-rose-200 transition-colors"
              >
                ⚠️ Pesan Mendesak
              </button>
            </div>
          ...
          <div className="pt-1 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
            <div className="text-[11px] text-slate-500 flex items-center gap-1">
              ...
              <span>
                Notifikasi dikirim melalui Web Push VAPID terenkripsi langsung ke browser &amp; HP.
              </span>
            </div>
            ...
            <button
              ...
              className={`px-5 py-2.5 rounded-xl font-bold text-xs flex items-center justify-center gap-2 shadow-sm transition-all shrink-0 ${
